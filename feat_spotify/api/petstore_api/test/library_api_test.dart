...
void main() {
  ...
  group(LibraryApi, () {
    ...
    //
    //Future changePlaylistDetails(String playlistId, { ChangePlaylistDetailsRequest changePlaylistDetailsRequest }) async
    ...
    //
    //Future<PlaylistObject> createPlaylist(String userId, { CreatePlaylistRequest createPlaylistRequest }) async
    ...
    //
    //Future followArtistsUsers(String type, String ids, { FollowArtistsUsersRequest followArtistsUsersRequest }) async
    ...
    //
    //Future removeAlbumsUser(String ids, { SaveAlbumsUserRequest saveAlbumsUserRequest }) async
    ...
    //
    //Future removeEpisodesUser(String ids, { RemoveEpisodesUserRequest removeEpisodesUserRequest }) async
    ...
    //
    //Future removeTracksUser(String ids, { SaveAlbumsUserRequest saveAlbumsUserRequest }) async
    ...
    //
    //Future saveAlbumsUser(String ids, { SaveAlbumsUserRequest saveAlbumsUserRequest }) async
    ...
    //
    //Future saveEpisodesUser(String ids, { SaveEpisodesUserRequest saveEpisodesUserRequest }) async
    ...
    //
    //Future saveTracksUser(String ids, { SaveTracksUserRequest saveTracksUserRequest }) async
    ...
    //
    //Future unfollowArtistsUsers(String type, String ids, { UnfollowArtistsUsersRequest unfollowArtistsUsersRequest }) async
