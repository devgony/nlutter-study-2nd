...
/// tests for PlayerApi
void main() {
  final instance = Openapi().getPlayerApi();
  ...
  group(PlayerApi, () {
    ...
    //
    //Future startAUsersPlayback({ String deviceId, StartAUsersPlaybackRequest startAUsersPlaybackRequest }) async
    ...
    //
    //Future transferAUsersPlayback({ TransferAUsersPlaybackRequest transferAUsersPlaybackRequest }) async
