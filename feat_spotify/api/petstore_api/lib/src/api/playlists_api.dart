...
class PlaylistsApi {
  ...
  Future<Response<ReorderOrReplacePlaylistsTracks200Response>> addTracksToPlaylist({ 
    ...
    try {
      const _type = FullType(AddTracksToPlaylistRequest);
      _bodyData = addTracksToPlaylistRequest == null ? null : _serializers.serialize(addTracksToPlaylistRequest, specifiedType: _type);
  ...
  Future<Response<void>> followPlaylist({ 
    ...
    try {
      const _type = FullType(FollowPlaylistRequest);
      _bodyData = followPlaylistRequest == null ? null : _serializers.serialize(followPlaylistRequest, specifiedType: _type);
  ...
  Future<Response<ReorderOrReplacePlaylistsTracks200Response>> reorderOrReplacePlaylistsTracks({ 
    ...
    try {
      const _type = FullType(ReorderOrReplacePlaylistsTracksRequest);
      _bodyData = reorderOrReplacePlaylistsTracksRequest == null ? null : _serializers.serialize(reorderOrReplacePlaylistsTracksRequest, specifiedType: _type);
