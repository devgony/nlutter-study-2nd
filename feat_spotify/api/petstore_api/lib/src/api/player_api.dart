...
class PlayerApi {
  ...
  Future<Response<void>> startAUsersPlayback({ 
    ...
    try {
      const _type = FullType(StartAUsersPlaybackRequest);
      _bodyData = startAUsersPlaybackRequest == null ? null : _serializers.serialize(startAUsersPlaybackRequest, specifiedType: _type);
  ...
  Future<Response<void>> transferAUsersPlayback({ 
    ...
    try {
      const _type = FullType(TransferAUsersPlaybackRequest);
      _bodyData = transferAUsersPlaybackRequest == null ? null : _serializers.serialize(transferAUsersPlaybackRequest, specifiedType: _type);
