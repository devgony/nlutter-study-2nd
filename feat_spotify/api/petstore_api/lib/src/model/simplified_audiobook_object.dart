...
abstract class SimplifiedAudiobookObject implements AudiobookBase {
...
class _$SimplifiedAudiobookObjectSerializer implements PrimitiveSerializer<SimplifiedAudiobookObject> {
  @override
  final Iterable<Type> types = const [SimplifiedAudiobookObject];
  ...
  SimplifiedAudiobookObject deserialize(
    ...
    return serializers.deserialize(serialized, specifiedType: FullType($SimplifiedAudiobookObject)) as $SimplifiedAudiobookObject;
  }
}

/// a concrete implementation of [SimplifiedAudiobookObject], since [SimplifiedAudiobookObject] is not instantiable
@BuiltValue(instantiable: true)
abstract class $SimplifiedAudiobookObject implements SimplifiedAudiobookObject, Built<$SimplifiedAudiobookObject, $SimplifiedAudiobookObjectBuilder> {
  $SimplifiedAudiobookObject._();

  factory $SimplifiedAudiobookObject([void Function($SimplifiedAudiobookObjectBuilder)? updates]) = _$$SimplifiedAudiobookObject;
...
class _$$SimplifiedAudiobookObjectSerializer implements PrimitiveSerializer<$SimplifiedAudiobookObject> {
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(SimplifiedAudiobookObject))!;
  }
