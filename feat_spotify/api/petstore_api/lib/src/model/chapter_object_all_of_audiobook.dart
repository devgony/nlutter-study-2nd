...
part 'chapter_object_all_of_audiobook.g.dart';
...
@BuiltValue()
abstract class ChapterObjectAllOfAudiobook implements SimplifiedAudiobookObject, Built<ChapterObjectAllOfAudiobook, ChapterObjectAllOfAudiobookBuilder> {
  ChapterObjectAllOfAudiobook._();

  factory ChapterObjectAllOfAudiobook([void updates(ChapterObjectAllOfAudiobookBuilder b)]) = _$ChapterObjectAllOfAudiobook;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ChapterObjectAllOfAudiobookBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ChapterObjectAllOfAudiobook> get serializer => _$ChapterObjectAllOfAudiobookSerializer();
}

class _$ChapterObjectAllOfAudiobookSerializer implements PrimitiveSerializer<ChapterObjectAllOfAudiobook> {
  @override
  final Iterable<Type> types = const [ChapterObjectAllOfAudiobook, _$ChapterObjectAllOfAudiobook];

  @override
  final String wireName = r'ChapterObjectAllOfAudiobook';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ChapterObjectAllOfAudiobook object, {
  ...
  void _deserializeProperties(
    ...
    required ChapterObjectAllOfAudiobookBuilder result,
  ...
  @override
  ChapterObjectAllOfAudiobook deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ChapterObjectAllOfAudiobookBuilder();
...
class ChapterObjectAllOfAudiobookTypeEnum extends EnumClass {

  /// The object type. 
  @BuiltValueEnumConst(wireName: r'audiobook')
  static const ChapterObjectAllOfAudiobookTypeEnum audiobook = _$chapterObjectAllOfAudiobookTypeEnum_audiobook;

  static Serializer<ChapterObjectAllOfAudiobookTypeEnum> get serializer => _$chapterObjectAllOfAudiobookTypeEnumSerializer;

  const ChapterObjectAllOfAudiobookTypeEnum._(String name): super(name);

  static BuiltSet<ChapterObjectAllOfAudiobookTypeEnum> get values => _$chapterObjectAllOfAudiobookTypeEnumValues;
  static ChapterObjectAllOfAudiobookTypeEnum valueOf(String name) => _$chapterObjectAllOfAudiobookTypeEnumValueOf(name);
}
