...
@BuiltValue()
abstract class TrackObject implements Built<TrackObject, TrackObjectBuilder> {
  @BuiltValueField(wireName: r'album')
  SimplifiedAlbumObject? get album;
  ...
  ExternalIdObject? get externalIds;
  ...
  TrackRestrictionObject? get restrictions;
  ...
  factory TrackObject([void updates(TrackObjectBuilder b)]) = _$TrackObject;
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.album != null) {
      ...
      yield serializers.serialize(
        object.album,
        specifiedType: const FullType(SimplifiedAlbumObject),
      );
    }
    ...
    if (object.externalIds != null) {
      ...
      yield serializers.serialize(
        object.externalIds,
        specifiedType: const FullType(ExternalIdObject),
      );
    }
    ...
    if (object.restrictions != null) {
      ...
      yield serializers.serialize(
        object.restrictions,
        specifiedType: const FullType(TrackRestrictionObject),
      );
    }
    if (object.name != null) {
      yield r'name';
