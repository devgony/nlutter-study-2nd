...
@BuiltValue()
abstract class FollowersObject implements Built<FollowersObject, FollowersObjectBuilder> {
  ...
  factory FollowersObject([void updates(FollowersObjectBuilder b)]) = _$FollowersObject;
