...
/// * [items] 
@BuiltValue()
abstract class PagingPlaylistTrackObject implements PagingObject, Built<PagingPlaylistTrackObject, PagingPlaylistTrackObjectBuilder> {
  @BuiltValueField(wireName: r'items')
  BuiltList<PlaylistTrackObject> get items;

  PagingPlaylistTrackObject._();

  factory PagingPlaylistTrackObject([void updates(PagingPlaylistTrackObjectBuilder b)]) = _$PagingPlaylistTrackObject;
