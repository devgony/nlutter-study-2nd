...
/// * [show_] 
@BuiltValue()
abstract class EpisodeObject implements EpisodeBase, Built<EpisodeObject, EpisodeObjectBuilder> {
  @BuiltValueField(wireName: r'show')
  EpisodeObjectAllOfShow get show_;

  EpisodeObject._();

  factory EpisodeObject([void updates(EpisodeObjectBuilder b)]) = _$EpisodeObject;
...
class _$EpisodeObjectSerializer implements PrimitiveSerializer<EpisodeObject> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.show_,
      specifiedType: const FullType(EpisodeObjectAllOfShow),
    );
    yield r'description';
    yield serializers.serialize(
      object.description,
    ...
    if (object.restrictions != null) {
      ...
      yield serializers.serialize(
        object.restrictions,
        specifiedType: const FullType(EpisodeRestrictionObject),
      );
    }
    ...
    yield object.audioPreviewUrl == null ? null : serializers.serialize(
    ...
    yield serializers.serialize(
      object.resumePoint,
      specifiedType: const FullType(ResumePointObject),
    );
    yield r'name';
    yield serializers.serialize(
      object.name,
