...
@BuiltValue()
abstract class AlbumObject implements AlbumBase, Built<AlbumObject, AlbumObjectBuilder> {
  ...
  AlbumObjectAllOfExternalIds get externalIds;
  ...
  AlbumObjectAllOfTracks get tracks;

  AlbumObject._();

  factory AlbumObject([void updates(AlbumObjectBuilder b)]) = _$AlbumObject;
...
class _$AlbumObjectSerializer implements PrimitiveSerializer<AlbumObject> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.externalIds,
      specifiedType: const FullType(AlbumObjectAllOfExternalIds),
    );
    ...
    yield serializers.serialize(
      object.tracks,
      specifiedType: const FullType(AlbumObjectAllOfTracks),
    );
    yield r'artists';
    yield serializers.serialize(
      object.artists,
      ...
      switch (key) {
        ...
        case r'external_ids':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(AlbumObjectAllOfExternalIds),
          ) as AlbumObjectAllOfExternalIds;
