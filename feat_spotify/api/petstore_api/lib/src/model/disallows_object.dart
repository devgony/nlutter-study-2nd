...
@BuiltValue()
abstract class DisallowsObject implements Built<DisallowsObject, DisallowsObjectBuilder> {
  ...
  factory DisallowsObject([void updates(DisallowsObjectBuilder b)]) = _$DisallowsObject;
