...
@BuiltValue()
abstract class PlaylistTracksRefObject implements Built<PlaylistTracksRefObject, PlaylistTracksRefObjectBuilder> {
  ...
  factory PlaylistTracksRefObject([void updates(PlaylistTracksRefObjectBuilder b)]) = _$PlaylistTracksRefObject;
