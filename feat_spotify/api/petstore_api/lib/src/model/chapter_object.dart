...
abstract class ChapterObject implements ChapterBase, Built<ChapterObject, ChapterObjectBuilder> {
  ...
  ChapterObjectAllOfAudiobook get audiobook;
...
class _$ChapterObjectSerializer implements PrimitiveSerializer<ChapterObject> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.audiobook,
      specifiedType: const FullType(ChapterObjectAllOfAudiobook),
    );
    yield r'images';
    yield serializers.serialize(
      object.images,
    ...
    if (object.restrictions != null) {
      ...
      yield serializers.serialize(
        object.restrictions,
        specifiedType: const FullType(ChapterRestrictionObject),
      );
    }
      ...
      switch (key) {
        ...
        case r'audiobook':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ChapterObjectAllOfAudiobook),
          ) as ChapterObjectAllOfAudiobook;
